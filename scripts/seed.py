...
def seed():
    ...
    with app.app_context():
        ...
        if not User.query.first():
            ...
            db.session.commit()
            print("Created demo users: admin@recoverai.com / admin123, reviewer@recoverai.com / reviewer123")
        ...
        if not Customer.query.first():
            ...
            db.session.commit()
            print(f"Seeded {len(customers)} customers and {txn_count} transactions")
